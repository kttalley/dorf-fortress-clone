...
export const PARTICLE_WEATHER_TYPES = {
  ...
  CLOUDS: {
    ...
    bgColor: '#444444',         // SOLID GREY - entire tile
    decay: 0.008,               // Very low - clouds stay whole
    gravity: 0.0,               // Floats
    windInfluence: 0.9,         // Driven by wind
    flowScale: 0.03,            // Medium-slow waves
    flowStrength: 0.25,         // Gentle rolling motion
    maxParticles: 400,          // Fuller clouds
  },
  MIST: {
    id: 'mist',
    realm: 'underground',
