...
export function createDwarf(x, y, name = null) {
  ...
  // Also kick off async LLM generation for potentially better result
  // This will update generatedName/generatedBio when complete
  requestNameBio(dwarf).catch(() => {
    // Already have fallback, ignore errors
  });
