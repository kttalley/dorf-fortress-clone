...
function formatBatchNameBioPrompt(entities, options = {}) {
  ...
  return `Generate creative names and short one-line bios for these ${entities.length} dwarves:

${list}

For each dwarf, provide EXACTLY this format:
ID: <number>
Name: <full name>
Bio: <one short sentence>
---

Generate all entries now:`;
}
