...
export function composeWeatherTile(x, y, terrain, tick, simulator = null) {
  ...
  // For clouds and other solid weather: render as SOLID COLOR BLOCK (no character)
  // This ensures only substantial grouped formations render (no isolated tiles)
  ...
  // SOLID WEATHER BLOCK: Show solid background color with blank character
  // This creates cohesive weather formations instead of scattered characters
  return {
    char: ' ',  // Blank - show just the color
    fg: weather.bgColor,  // Foreground is the weather color for visibility
    bg: weather.bgColor,  // Both foreground and background the same
    animated: false,
