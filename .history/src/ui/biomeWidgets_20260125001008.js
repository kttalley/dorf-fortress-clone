...
function applyEventLogMobileStyles() {
  ...
  if (isMobile) {
    if (eventLogMinimized) {
      ...
      eventLogEl.style.width = '44px';
      eventLogEl.style.height = '44px';
      eventLogEl.style.maxHeight = '44px';
      eventLogEl.style.borderRadius = '50%';
      eventLogEl.style.right = '8px';
      eventLogEl.style.top = '100px';
      if (header) {
