...
export function initGameAssistant(containerEl, getWorld) {
  ...
  infoModalEl.innerHTML = `
    ...
    <div style="color: #aaa; font-size: 11px; line-height: 1.5;">
      <p style="margin: 0 0 8px;">The Game Assistant analyzes your fortress's current state and answers questions about your dwarves, resources, and relationships.</p>
