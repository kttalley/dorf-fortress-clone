/**
 * Game Assistant Panel - Chat UI for colony analysis
 ...
 */
export function initGameAssistant(containerEl, getWorld) {
  // Create main panel
  ...
  inputAreaEl.innerHTML = `
    <div style="display: flex; gap: 8px;">
      <input type="text" placeholder="Ask about your colony..." style="
        flex: 1;
  ...
  infoModalEl.innerHTML = `
    <div style="font-weight: bold; color: #fff; margin-bottom: 10px;">How it works</div>
    <div style="color: #aaa; font-size: 11px; line-height: 1.5;">
      <p style="margin: 0 0 8px;">The Game Assistant analyzes your colony's current state and answers questions about your dwarves, resources, and relationships.</p>
      <p style="margin: 0 0 8px;"><strong style="color: #4aff9e;">What it can do:</strong><br/>
      • Analyze trends and patterns<br/>
      • Identify potential issues<br/>
      • Explain dwarf behaviors<br/>
      • Compare statistics</p>
      <p style="margin: 0 0 8px;"><strong style="color: #ff9e4a;">What it won't do:</strong><br/>
  ...
  function renderLoading() {
    ...
    loadingEl.innerHTML = `
      ...
      <div style="animation: pulse 1s infinite;">Analyzing colony data...</div>
    `;
